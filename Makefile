...
$(call build-image,openshift-acme-controller,$(IMAGE_REGISTRY)/$(IMAGE_ORG)/openshift-acme:controller,./images/openshift-acme-controller/Dockerfile,.)
$(call build-image,openshift-acme-exposer,$(IMAGE_REGISTRY)/$(IMAGE_ORG)/openshift-acme:exposer, ./images/openshift-acme-exposer/Dockerfile,.)
